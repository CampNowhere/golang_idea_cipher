...
func NewCipher(key []byte) IdeaCipher {
	...
	/*
		Is there a better way to do this? Almost certainly. But the complexity of
		doing it algorithmically in a for loop isn't worth it. Just think of it as
		a performance boost from unrolling a loop ;-)
	*/
